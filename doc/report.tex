...
\author{
	\\Ana Catarina Macedo\\
		\texttt{\smaller a54773@alunos.uminho.pt}
	\and
    \\Miguel Palhas\\
...
\newcommand{\nvidia}{NVidia\tr\xspace}

\newcommand{\todopfac}{\todo[inline,color=blue!40]}
...
\begin{document}
	...
	\input{report/200-papi}
	\input{report/300-cuda}
	\input{report/400-papi-cuda}
	\input{report/500-testing}
	\input{report/600-results}
	\input{report/700-analysis}
