...
PAPI also attempts to deal with some of the limitations of hardware counters, like it's limited amount. For instance, an Intel Xeon cenas coisas has only X real hardware counters. \todo[inline]{Substituir cenas coisas por um processador a sério, e X pelo nº de contadores}.
